...
public static class DesktopService
{
    ...
    /// <summary>Moves and resizes an embedded (child) window using physical pixel coordinates.</summary>
    public static void MoveResizeEmbeddedWindow(Window window, int x, int y, int w, int h)
    {
        var handle = new WindowInteropHelper(window).Handle;
